...
class BudgetPlanDeleteScreen extends StatefulWidget {
  final BudgetPlanData budgetPlanData;

  const BudgetPlanDeleteScreen({
    super.key,
    required this.budgetPlanData,
  });

  @override
  State<BudgetPlanDeleteScreen> createState() => _BudgetPlanDeleteScreenState();
}

class _BudgetPlanDeleteScreenState extends State<BudgetPlanDeleteScreen> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      bool success = await store.delete(widget.budgetPlanData);
