...
class UpcomingBillDeleteScreen extends StatefulWidget {
  final UpcomingBillData upcomingBillData;

  const UpcomingBillDeleteScreen({
    super.key,
    required this.upcomingBillData,
  });

  @override
  State<UpcomingBillDeleteScreen> createState() =>
      _UpcomingBillDeleteScreenState();
}

class _UpcomingBillDeleteScreenState extends State<UpcomingBillDeleteScreen> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      bool success = await store.delete(widget.upcomingBillData);
  ...
  Widget _buildLoadingScreen() {
    return Observer(builder: (context) {
      return store.createStatus == LoadingStatusEnum.done
          ? LoadingScreen(
              title: 'Upcoming Bill Delete Successfully!',
